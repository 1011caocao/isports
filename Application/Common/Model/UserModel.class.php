...
class UserModel extends Model
{
    ...
    protected $_validate=array(
        ...
        array('package','require','套餐必选'),
        array('height','require','身高必填'),
        array('weight','require','体重必填'),
        array('phone','number','电话号码必须为数字'),
        array('height','number','身高必须为数字'),
        array('weight','number','体重必须为数字'),
