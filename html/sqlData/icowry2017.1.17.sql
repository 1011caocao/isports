...
-- ----------------------------
INSERT INTO `ic_activity_type` VALUES ('1', '讲座论坛', '1481698507', '1');
...
CREATE TABLE `ic_apply_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='合作动态表';
...
CREATE TABLE `ic_artist_publish` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='演艺需求发布';
...
CREATE TABLE `ic_art_licence` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `uid` int(11) NOT NULL COMMENT '用户id',
  `nane` varchar(50) NOT NULL COMMENT '演艺人证书',
  `path` varchar(200) NOT NULL COMMENT '证书路径',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='演艺人的证书表，每人最多三张';
...
CREATE TABLE `ic_art_type` (
  ...
  `status` tinyint(2) DEFAULT '0' COMMENT '状态，0为禁用，1为启用',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='演艺类型';

-- ----------------------------
-- Records of ic_art_type
-- ----------------------------
INSERT INTO `ic_art_type` VALUES ('1', '主持', '1481701695', '1');
...
CREATE TABLE `ic_business_apply` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '申请状态，-2为被拒绝，-1为审核未通过，0为待审核，1为申请中，2为通过申请',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商业活动申请';
...
CREATE TABLE `ic_business_publish` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `uid` int(11) NOT NULL COMMENT '用户id',
  `status` tinyint(2) DEFAULT '0' COMMENT '发布状态：0为正在审核，1为已发布，2已完成、',
  ...
  `apply_end_time` varchar(12) DEFAULT '' COMMENT '申请结束时间',
  `activity_start_time` varchar(12) NOT NULL DEFAULT '' COMMENT '活动开始时间',
  ...
  `apply_ing` int(4) DEFAULT '0' COMMENT '已经通过申请的人数',
  `apply_total` varchar(3) NOT NULL COMMENT '活动申请名额',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='商业活动发布';

-- ----------------------------
-- Records of ic_business_publish
-- ----------------------------
INSERT INTO `ic_business_publish` VALUES ('1', '2', '1', '可口可乐春季营销', '1', '外场摆点', '5000.00', '30', '1482986501', '1492986800', '1482989000', '1482990000', '26', '322', '2722', '0', '四川大学', '2', '500', null, '', '1，2', '', '1,2', '0', '11', '1482286500', '', '');
INSERT INTO `ic_business_publish` VALUES ('2', '2', '1', '可口可乐夏季营销', '6', '传单派送', '2000.00', '30', '1482986501', '1492986800', '1482989000', '1482990000', '26', '322', '2722', '0', '四川理工学院', '2', '1000', '0', '', '2，3', '', '1', '0', '10', '1482286500', '', '');
INSERT INTO `ic_business_publish` VALUES ('3', '2', '1', '可口可乐夏季营销', '6', '传单派送', '2000.00', '30', '1482986501', '1492986800', '1482989000', '1482990000', '26', '322', '2722', '0', '成都大学', '2', '1000', '0', '', '2，3', '', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_business_publish` VALUES ('4', '2', '1', '可口可乐夏季营销', '6', '传单派送', '2000.00', '30', '1482986501', '1492986800', '1482989000', '1482990000', '26', '322', '2722', '0', '成都大学京江学院', '2', '1000', '0', '', '2，3', '', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_business_publish` VALUES ('5', '2', '1', '可口可乐夏季营销', '6', '传单派送', '2000.00', '30', '1482986501', '1492986800', '1482989000', '1482990000', '26', '322', '2722', '0', '成都中医大学', '2', '1000', '0', '', '2，3', '', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_business_publish` VALUES ('6', '2', '1', '可口可乐夏季营销', '6', '传单派送', '2000.00', '30', '1482986501', '1492986800', '1482989000', '1482990000', '26', '339', '0', '0', '宜宾学院', '2', '1000', '0', '', '2，3', '', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_business_publish` VALUES ('7', '2', '1', '可口可乐夏季营销', '6', '传单派送', '2000.00', '30', '1482986501', '1492986800', '1482989000', '1482990000', '26', '339', '0', '0', '宜宾学院', '2', '1000', '0', '', '2，3', '', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_business_publish` VALUES ('8', '2', '1', '可口可乐夏季营销', '6', '传单派送', '2000.00', '30', '1482986501', '1492986800', '1482989000', '1482990000', '26', '339', '0', '0', '宜宾学院', '2', '1000', '0', '', '2，3', '', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_business_publish` VALUES ('9', '2', '1', '可口可乐夏季营销', '6', '传单派送', '2000.00', '30', '1482986501', '1492986800', '1482989000', '1482990000', '26', '339', '0', '0', '宜宾学院', '2', '1000', '0', '', '2，3', '', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_business_publish` VALUES ('10', '2', '1', '可口可乐夏季营销', '6', '传单派送', '2000.00', '30', '1482986501', '1492986800', '1482989000', '1482990000', '26', '339', '0', '0', '宜宾学院', '2', '1000', '0', '', '2，3', '', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_business_publish` VALUES ('11', '2', '1', '可口可乐夏季营销', '6', '传单派送', '2000.00', '30', '1482986501', '1492986800', '1482989000', '1482990000', '26', '339', '0', '0', '宜宾学院', '2', '1000', '0', '', '2，3', '', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_business_publish` VALUES ('12', '2', '1', '可口可乐夏季营销', '6', '传单派送', '2000.00', '30', '1482986501', '1492986800', '1482989000', '1482990000', '26', '339', '0', '0', '宜宾学院', '3', '1000', '0', '', '2，3', '', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_business_publish` VALUES ('13', '2', '1', '可口可乐夏季营销', '6', '传单派送', '2000.00', '30', '1482986501', '1492986800', '1482989000', '1482990000', '2', '52', '500', '0', '北京大学', '3', '1000', '0', '', '2，3', '', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_business_publish` VALUES ('14', '2', '1', '可口可乐夏季营销', '6', '传单派送', '2000.00', '30', '1482986501', '1492986800', '1482989000', '1482990000', '2', '52', '500', '0', '北京大学', '3', '1000', '0', '', '2，3', '', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_business_publish` VALUES ('15', '2', '1', '可口可乐夏季营销', '6', '传单派送', '2000.00', '30', '1482986501', '1492986800', '1482989000', '1482990000', '2', '52', '500', '0', '北京大学', '3', '1000', '0', '', '2，3', '', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_business_publish` VALUES ('16', '2', '1', '可口可乐夏季营销', '6', '传单派送', '2000.00', '30', '1482986501', '1492986800', '1482989000', '1482990000', '2', '52', '500', '0', '北京大学', '3', '1000', '0', '', '2，3', '', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_business_publish` VALUES ('17', '2', '1', '可口可乐夏季营销', '6', '传单派送', '2000.00', '30', '1482986501', '1492986800', '1482989000', '1482990000', '2', '52', '500', '0', '北京大学', '3', '1000', '0', '', '2，3', '', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_business_publish` VALUES ('18', '2', '1', '可口可乐夏季营销', '6', '传单派送', '2000.00', '30', '1482986501', '1492986800', '1482989000', '1482990000', '2', '52', '500', '0', '北京大学', '3', '1000', '0', '', '2，3', '', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_business_publish` VALUES ('19', '2', '1', '可口可乐夏季营销', '6', '传单派送', '2000.00', '30', '1482986501', '1492986800', '1482989000', '1482990000', '2', '52', '500', '0', '北京大学', '3', '1000', '0', '', '2，3', '', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_business_publish` VALUES ('20', '2', '1', '可口可乐夏季营销', '6', '传单派送', '2000.00', '30', '1482986501', '1492986800', '1482989000', '1482990000', '2', '52', '500', '0', '北京大学', '3', '1000', '0', '', '2，3', '', '1', '0', '0', '1482286500', '', '');
...
CREATE TABLE `ic_campaign_type` (
  ...
  `status` tinyint(2) DEFAULT '0' COMMENT '状态，0为禁用，1为启用',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='活动宣传方式';

-- ----------------------------
-- Records of ic_campaign_type
-- ----------------------------
INSERT INTO `ic_campaign_type` VALUES ('1', '传单', '1481701695', '1');
...
CREATE TABLE `ic_case_show` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='传媒公司案列展示，学校组织案列展示，演艺人形象才艺展示';
...
CREATE TABLE `ic_certification` (
  ...
  `height` float(4,2) DEFAULT '0.00' COMMENT '身高',
  `art_type` tinyint(2) DEFAULT '0' COMMENT '演艺类型',
  ...
  `licence_name` varchar(50) DEFAULT '' COMMENT '执照名称',
...
-- ----------------------------
INSERT INTO `ic_certified_user` VALUES ('2', '', '', '0', '0.00', '0', '', '', '', '', '0', '', '0', '', '0', '', '', '可口可乐四川分公司', '', '', '0', null, '', '', '', '0.0', '0', '10', '0', '');
INSERT INTO `ic_certified_user` VALUES ('3', '', '', '0', '0.00', '0', '', '', '', '', '0', '', '0', '', '0', '', '', '四川理工计科学院', '', '', '0', null, '', '', '', '0.0', '0', '10', '0', '');
INSERT INTO `ic_certified_user` VALUES ('4', '', '', '0', '0.00', '0', '', '', '', '', '0', '', '0', '', '0', '', '', '内江师范学院', '', '', '0', null, '', '', '', '0.0', '0', '10', '0', '');
...
CREATE TABLE `ic_coin_cost_type` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='珍珠币使用类型';
...
CREATE TABLE `ic_company_img` (
  ...
  `add_time` varchar(12) NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='甲方企业风采照片或演艺人风采';
...
CREATE TABLE `ic_group_publish` (
  ...
  `apply_ing` int(4) DEFAULT '0' COMMENT '已经通过申请的人数',
  `apply_total` varchar(3) NOT NULL COMMENT '赞助申请名额',
  ...
  `option_time` varchar(12) DEFAULT '' COMMENT '认证操作时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='校园活动发布';

-- ----------------------------
-- Records of ic_group_publish
-- ----------------------------
INSERT INTO `ic_group_publish` VALUES ('1', '3', '1', '2017冬季迎新晚会', '3', '晚会典礼', '5000.00', '2', '1493568000', '1493568000', '1493568000', '1493968000', '26', '341', '2722', '0', '成都理工大学', '4', '3000', '0', '', '1,2,5', '', '1,2', '0', '0', '1', '', '');
INSERT INTO `ic_group_publish` VALUES ('2', '3', '1', '计科学院健美操大赛', '2', '竞技比赛', '6000.00', '3', '1493568000', '1493568000', '1493568000', '1493968000', '2', '52', '500', '0', '北京理工大学', '4', '5000', '0', '', '1,2,4', '', '1,2', '0', '0', '1', '', '');
INSERT INTO `ic_group_publish` VALUES ('3', '3', '1', '计科学院健美操大赛', '2', '竞技比赛', '6000.00', '3', '1493568000', '1493568000', '1493568000', '1493968000', '2', '52', '500', '0', '北京理工大学', '4', '5000', '0', '', '1,2,4', '', '1,2', '0', '0', '1', '', '');
INSERT INTO `ic_group_publish` VALUES ('4', '3', '1', '计科学院健美操大赛', '2', '竞技比赛', '6000.00', '3', '1493568000', '1493568000', '1493568000', '1493968000', '2', '52', '500', '0', '北京理工大学', '4', '5000', '0', '', '1,2,4', '', '1,2', '0', '0', '1', '', '');
INSERT INTO `ic_group_publish` VALUES ('5', '3', '1', '计科学院健美操大赛', '2', '竞技比赛', '6000.00', '3', '1493568000', '1493568000', '1493568000', '1493968000', '2', '52', '500', '0', '北京理工大学', '4', '5000', '0', '', '1,2,4', '', '1,2', '0', '0', '1', '', '');
INSERT INTO `ic_group_publish` VALUES ('6', '3', '1', '计科学院健美操大赛', '2', '竞技比赛', '6000.00', '3', '1493568000', '1493568000', '1493568000', '1493968000', '2', '52', '500', '0', '北京理工大学', '4', '5000', '0', '', '1,2,4', '', '1,2', '0', '0', '1', '', '');
INSERT INTO `ic_group_publish` VALUES ('7', '3', '1', '计科学院健美操大赛', '2', '竞技比赛', '6000.00', '3', '1493568000', '1493568000', '1493568000', '1493968000', '2', '52', '500', '0', '北京理工大学', '4', '5000', '0', '', '1,2,4', '', '1,2', '0', '0', '1', '', '');
INSERT INTO `ic_group_publish` VALUES ('8', '3', '1', '计科学院健美操大赛', '2', '竞技比赛', '6000.00', '3', '1493568000', '1493568000', '1493568000', '1493968000', '2', '52', '500', '0', '北京理工大学', '4', '5000', '0', '', '1,2,4', '', '1,2', '0', '0', '1', '', '');
INSERT INTO `ic_group_publish` VALUES ('9', '3', '1', '计科学院健美操大赛', '2', '竞技比赛', '6000.00', '3', '1493568000', '1493568000', '1493568000', '1493968000', '26', '335', '2863', '0', '内江师范', '4', '5000', '0', '', '1,2,4', '', '1,2', '0', '0', '1', '', '');
INSERT INTO `ic_group_publish` VALUES ('10', '3', '1', '计科学院健美操大赛', '2', '竞技比赛', '6000.00', '3', '1493568000', '1493568000', '1493568000', '1493968000', '26', '335', '2863', '0', '内江师范', '4', '5000', '0', '', '1,2,4', '', '1,2', '0', '0', '1', '', '');
INSERT INTO `ic_group_publish` VALUES ('11', '3', '1', '计科学院健美操大赛', '2', '竞技比赛', '6000.00', '3', '1493568000', '1493568000', '1493568000', '1493968000', '26', '335', '2863', '0', '内江师范', '4', '5000', '0', '', '1,2,4', '', '1,2', '0', '0', '1', '', '');
INSERT INTO `ic_group_publish` VALUES ('12', '3', '1', '计科学院健美操大赛', '2', '竞技比赛', '6000.00', '3', '1493568000', '1493568000', '1493568000', '1493968000', '26', '335', '2863', '0', '内江师范', '4', '5000', '0', '', '1,2,4', '', '1,2', '0', '0', '1', '', '');
...
CREATE TABLE `ic_icowry_log` (
  ...
  PRIMARY KEY (`uid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='珍珠币记录';
...
-- ----------------------------
INSERT INTO `ic_identity_count` VALUES ('1', 'campany', '120');
INSERT INTO `ic_identity_count` VALUES ('2', 'resource', '999');
INSERT INTO `ic_identity_count` VALUES ('3', 'group', '888');
INSERT INTO `ic_identity_count` VALUES ('4', 'actor ', '122');
...
CREATE TABLE `ic_identity_img` (
  ...
  `add_time` varchar(12) NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='身份证照片信息';
...
INSERT INTO `ic_menu` VALUES ('27', '业务中心', '0', 'home', 'businessCenter', '', '', '', '0', '1', '2');
...
INSERT INTO `ic_menu` VALUES ('34', '消息中心', '0', 'home', 'messageCenter', '', '', '', '0', '1', '2');
...
INSERT INTO `ic_menu` VALUES ('37', '服务中心', '0', 'home', 'serviceCenter', '', '', '', '0', '1', '2');
INSERT INTO `ic_menu` VALUES ('38', '申请维权', '37', 'home', 'serviceCenter', 'applyProtect', '', '', '0', '1', '2');
...
CREATE TABLE `ic_resources_img` (
  ...
  `add_time` varchar(12) NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='资源图片信息';
...
CREATE TABLE `ic_resources_publish` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `uid` int(11) NOT NULL COMMENT '用户id',
  `status` tinyint(2) DEFAULT '0' COMMENT '发布状态：0为正在审核，1为已发布',
  `name` varchar(20) NOT NULL COMMENT '传媒资源名称',
  `province_id` int(11) DEFAULT '0' COMMENT '省份id',
  `city_id` int(11) DEFAULT '0' COMMENT '城市id',
  `county_id` int(11) DEFAULT '0' COMMENT '县id',
  `school_id` varchar(30) NOT NULL COMMENT '所在学校，可以选择多个存放id,可以选择不限',
  ...
  `money` decimal(10,2) NOT NULL COMMENT '每天的价格',
  `prepay_ratio` int(3) NOT NULL COMMENT '预付比例',
  ...
  `option_time` varchar(12) DEFAULT '' COMMENT '认证操作时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='传媒资源发布';

-- ----------------------------
-- Records of ic_resources_publish
-- ----------------------------
INSERT INTO `ic_resources_publish` VALUES ('1', '4', '1', '内江师范天一广场', '26', '335', '2863', '1,2,3', '四川大学望江校区，成都体育学院，四川大学江安校区', '4', '2', '广场资源', '5', '体育馆', '3000', '400', '500.00', '2', '1493568000', '1493578000', '地广人多，嘿嘿嘿嘿嘿嘿嘿嘿嘿hi恶黑恶hi', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_resources_publish` VALUES ('2', '4', '1', '成都大学', '26', '322', '2722', '0', '', '4', '2', '场馆资源', '5', '体育馆', '3000', '500', '2000.00', '2', '1493568000', '1493578000', '地广人多，嘿嘿嘿嘿嘿嘿嘿嘿嘿hi恶黑恶hi这是那啥', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_resources_publish` VALUES ('3', '4', '1', '内江师范天一广场', '26', '335', '2863', '3', '四川大学江安校区', '4', '2', '广场资源', '5', '体育馆', '3000', '400', '500.00', '2', '1493568000', '1493578000', '地广人多，嘿嘿嘿嘿嘿嘿嘿嘿嘿hi恶黑恶hi', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_resources_publish` VALUES ('4', '4', '1', '内江师范天一广场', '26', '335', '2863', '1', '四川大学望江校区', '4', '2', '广场资源', '5', '体育馆', '3000', '400', '500.00', '2', '1493568000', '1493578000', '地广人多，嘿嘿嘿嘿嘿嘿嘿嘿嘿hi恶黑恶hi', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_resources_publish` VALUES ('5', '4', '1', '内江师范天一广场', '26', '335', '2863', '2,3', '成都体育学院，四川大学江安校区', '4', '2', '广场资源', '5', '体育馆', '3000', '400', '500.00', '2', '1493568000', '1493578000', '地广人多，嘿嘿嘿嘿嘿嘿嘿嘿嘿hi恶黑恶hi', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_resources_publish` VALUES ('6', '4', '1', '内江师范天一广场', '26', '335', '2863', '2,3', '成都体育学院，四川大学江安校区', '4', '2', '广场资源', '5', '体育馆', '3000', '400', '500.00', '2', '1493568000', '1493578000', '地广人多，嘿嘿嘿嘿嘿嘿嘿嘿嘿hi恶黑恶hi', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_resources_publish` VALUES ('7', '4', '1', '内江师范天一广场', '26', '335', '2863', '2,3', '成都体育学院，四川大学江安校区', '4', '2', '广场资源', '5', '体育馆', '3000', '400', '500.00', '2', '1493568000', '1493578000', '地广人多，嘿嘿嘿嘿嘿嘿嘿嘿嘿hi恶黑恶hi', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_resources_publish` VALUES ('8', '4', '1', '内江师范天一广场', '26', '335', '2863', '2,3', '成都体育学院，四川大学江安校区', '4', '1', '广场资源', null, '', '3000', '400', '500.00', '2', '1493568000', '1493578000', '地广人多，嘿嘿嘿嘿嘿嘿嘿嘿嘿hi恶黑恶hi', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_resources_publish` VALUES ('9', '4', '1', '广西南宁清秀大学广场', '7', '97', '854', '2,3', '成都体育学院，四川大学江安校区', '4', '1', '广场资源', null, '', '3000', '400', '500.00', '2', '1493568000', '1493578000', '地广人多，嘿嘿嘿嘿嘿嘿嘿嘿嘿hi恶黑恶hi', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_resources_publish` VALUES ('10', '4', '1', '广西南宁清秀大学广场', '7', '97', '854', '2,3', '成都体育学院，四川大学江安校区', '4', '1', '广场资源', null, '', '3000', '400', '500.00', '2', '1493568000', '1493578000', '地广人多，嘿嘿嘿嘿嘿嘿嘿嘿嘿hi恶黑恶hi', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_resources_publish` VALUES ('11', '4', '1', '广西南宁清秀大学广场', '7', '97', '854', '2,3', '成都体育学院，四川大学江安校区', '4', '1', '广场资源', null, '', '3000', '400', '500.00', '2', '1493568000', '1493578000', '地广人多，嘿嘿嘿嘿嘿嘿嘿嘿嘿hi恶黑恶hi', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_resources_publish` VALUES ('12', '4', '1', '广西南宁清秀大学广场', '7', '97', '854', '2,3', '成都体育学院，四川大学江安校区', '4', '1', '广场资源', null, '', '3000', '400', '500.00', '2', '1493568000', '1493578000', '地广人多，嘿嘿嘿嘿嘿嘿嘿嘿嘿hi恶黑恶hi', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_resources_publish` VALUES ('13', '4', '1', '广西南宁清秀大学广场', '7', '97', '854', '2,3', '成都体育学院，四川大学江安校区', '4', '1', '广场资源', null, '', '3000', '400', '500.00', '2', '1493568000', '1493578000', '地广人多，嘿嘿嘿嘿嘿嘿嘿嘿嘿hi恶黑恶hi', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_resources_publish` VALUES ('14', '4', '1', '广西南宁清秀大学广场', '7', '97', '854', '2,3', '成都体育学院，四川大学江安校区', '4', '1', '广场资源', null, '', '3000', '400', '500.00', '2', '1493568000', '1493578000', '地广人多，嘿嘿嘿嘿嘿嘿嘿嘿嘿hi恶黑恶hi', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_resources_publish` VALUES ('15', '4', '1', '广西南宁清秀大学广场', '7', '97', '854', '2,3', '成都体育学院，四川大学江安校区', '4', '1', '广场资源', null, '', '3000', '400', '500.00', '2', '1493568000', '1493578000', '地广人多，嘿嘿嘿嘿嘿嘿嘿嘿嘿hi恶黑恶hi', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_resources_publish` VALUES ('16', '4', '1', '广西南宁清秀大学广场', '7', '97', '854', '2,3', '成都体育学院，四川大学江安校区', '4', '1', '广场资源', null, '', '3000', '400', '500.00', '2', '1493568000', '1493578000', '地广人多，嘿嘿嘿嘿嘿嘿嘿嘿嘿hi恶黑恶hi', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_resources_publish` VALUES ('17', '4', '1', '广西南宁清秀大学广场', '7', '97', '854', '2,3', '成都体育学院，四川大学江安校区', '4', '1', '广场资源', null, '', '3000', '400', '500.00', '2', '1493568000', '1493578000', '地广人多，嘿嘿嘿嘿嘿嘿嘿嘿嘿hi恶黑恶hi', '1', '0', '0', '1482286500', '', '');
INSERT INTO `ic_resources_publish` VALUES ('18', '4', '1', '广西南宁清秀大学广场', '7', '97', '854', '2,3', '成都体育学院，四川大学江安校区', '4', '13', '其他', null, '', '3000', '400', '500.00', '2', '1493568000', '1493578000', '地广人多，嘿嘿嘿嘿嘿嘿嘿嘿嘿hi恶黑恶hi', '1', '0', '0', '1482286500', '', '');
...
CREATE TABLE `ic_resource_apply` (
  ...
  `apply_finish_time` varchar(12) NOT NULL COMMENT '申请完成时间，状态为2，时间完成',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='资源活动申请';
...
-- Records of ic_user
-- ----------------------------
INSERT INTO `ic_user` VALUES ('1', '1', '15700353202', 'oZaoZnYRsWXqndVvtolGagqkCRmCfSmd', '07764520aa737cc07733f4e8519d5344', 'zWhAIu', '', '1', '1482214711', '127.0.0.1', '1484210584', '127.0.0.1');
INSERT INTO `ic_user` VALUES ('2', '1', '13982249485', '', 'e2154a8f0f707f9e5978ea70571f915e', 'eCPoAG', '', '0', '1482219590', '127.0.0.1', '', '0.0.0.0');
INSERT INTO `ic_user` VALUES ('4', '1', '15700353201', '', '5583406137eeef4a4c3f9d4bba12a82f', 'NpSTnw', '', '0', '1484099023', '127.0.0.1', '', '0.0.0.0');
