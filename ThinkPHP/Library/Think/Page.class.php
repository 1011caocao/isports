...
//     );
    ...
    // 后台分页显示定制
    private $adminConfig  = array(
    		'header' => '<li class="disabled hwh-page-info"><a>共<em>%TOTAL_ROW%</em>条  <em>%NOW_PAGE%</em>/%TOTAL_PAGE%页</a></li>',
    		'prev'   => '上一页',
    		'next'   => '下一页',
    		'first'  => '首页',
    		'last'   => '末页',
    ...
    // 前端分页显示定制
    private $homeConfig  = array(
    		'header' => '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="disabled hwh-page-info" style="display:block;height:34px;line-height:34px;float:right;"><a>共%TOTAL_PAGE%页</a></span>',
    ...
    public function __construct($totalRows, $listRows=20, $parameter = array()) {
        ...
        if(strtolower(MODULE_NAME)=='admin'){
        	$this->config = $this->adminConfig;
        }else{
        	$this->config = $this->homeConfig;
        }
    }
    ...
    public function show() {
        ...
        $this->parameter[$this->p] = '[PAGE]';
     	if(strtolower(MODULE_NAME)=='admin'){
        	...
        	$this->url = U(ACTION_NAME, $this->parameter).C('QUERY_POINT');
        }
        /* 计算分页信息 */
        ...
        $page_str = str_replace(
            ...
            $this->config['theme']);
        return bootstrap_page_style("<div>{$page_str}</div>");
    }
}
